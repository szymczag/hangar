...
The latest published chart is `0.1.0-rc.34` (`appVersion: v0.1.0-rc.34`). Its
...
Release `0.1.0-rc.34` is available from the
[GitHub Release](https://github.com/szymczag/hangar/releases/tag/hangar-v0.1.0-rc.34)
