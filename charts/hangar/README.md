...
The latest published chart is `0.1.0-rc.25` (`appVersion: v0.1.0-rc.25`). Its
...
Do not use `0.1.0-rc.1`, `0.1.0-rc.2`, `0.1.0-rc.20`, or `0.1.0-rc.24`; those
immutable versions were consumed by incomplete release attempts. `0.1.0-rc.24`
published only a subset of its container set and no chart. `0.1.0-rc.23` is the
immediately previous complete publication, but it predates the authorization,
object-scope, and request-input hardening in `rc.25`.
Earlier `rc.12` through `rc.17` additionally contain frontend migration failures.
Use `0.1.0-rc.25`; there is no security-equivalent
...
Release `0.1.0-rc.25` is available from the
[GitHub Release](https://github.com/szymczag/hangar/releases/tag/hangar-v0.1.0-rc.25)
