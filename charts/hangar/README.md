...
The current chart is `0.1.0-rc.4` (`appVersion: v0.1.0-rc.4`). Its
...
by incomplete release attempts. `0.1.0-rc.3` is the previous complete release.
...
Release `0.1.0-rc.4` is available from the
[GitHub Release](https://github.com/szymczag/hangar/releases/tag/hangar-v0.1.0-rc.4)
