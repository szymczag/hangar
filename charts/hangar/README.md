...
The latest published chart is `0.1.0-rc.20` (`appVersion: v0.1.0-rc.20`). Its
...
by incomplete release attempts. `0.1.0-rc.19` is the immediately previous
...
hardening in `rc.20`. Earlier `rc.12` through `rc.17` additionally contain
frontend migration failures. Use `0.1.0-rc.20`; there is no security-equivalent
...
Release `0.1.0-rc.20` is available from the
[GitHub Release](https://github.com/szymczag/hangar/releases/tag/hangar-v0.1.0-rc.20)
