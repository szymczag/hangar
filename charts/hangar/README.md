...
The latest published chart is `0.1.0-rc.17` (`appVersion: v0.1.0-rc.17`). Its
...
by incomplete release attempts. `0.1.0-rc.16` is the immediately previous
complete publication, but Popper-positioned Headless UI panels can be clipped
by task layout overflow or hidden behind surrounding content. `0.1.0-rc.15`
has the upper-left positioning failure, `0.1.0-rc.14` has the earlier dropdown
interaction failure, `0.1.0-rc.13` has the Fragment-backed combo-box failure,
and `0.1.0-rc.12` additionally has hydration and transition failures. Use
`0.1.0-rc.17`; `0.1.0-rc.11` remains the qualified rollback target.
...
Release `0.1.0-rc.17` is available from the
[GitHub Release](https://github.com/szymczag/hangar/releases/tag/hangar-v0.1.0-rc.17)
