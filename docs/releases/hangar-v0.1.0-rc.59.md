...
Product version is `v0.1.0-rc.59`, Git tag `hangar-v0.1.0-rc.59`, Helm chart version
`0.1.0-rc.59`, and OCI chart `ghcr.io/szymczag/charts/hangar:0.1.0-rc.59`. No chart
...
Rollback to rc.58 restores the previous images. The list returns to showing every work
