...
| `img-src`                                                                        | `'self' blob: data:` plus object storage                                                | uploads and previews; no image is loaded from another host                                                                            |
| `connect-src`                                                                    | `'self'` plus object storage                                                            | the API, the live WebSocket, uploads and the emoji picker's data are all this instance's                                              |
