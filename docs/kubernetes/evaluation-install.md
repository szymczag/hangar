...
This tutorial installs Hangar `0.1.0-rc.19` in a dedicated namespace with bundled,
...
```bash
export CHART_VERSION=0.1.0-rc.19
...
Confirm the output reports chart version `0.1.0-rc.19`, application version
`v0.1.0-rc.19`, and the expected Kubernetes version constraint.

For higher-assurance environments, complete [artifact verification](security.md#verify-release-010-rc19)
before installation.
...
curl --fail --location --silent --show-error \
  ...
  https://raw.githubusercontent.com/szymczag/hangar/hangar-v0.1.0-rc.19/charts/hangar/examples/evaluation-secrets.example.yaml
```
