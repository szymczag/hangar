...
This tutorial installs Hangar `0.1.0-rc.51` in a dedicated namespace with bundled,
...
```bash
export CHART_VERSION=0.1.0-rc.51
...
Confirm the output reports chart version `0.1.0-rc.51`, application version
`v0.1.0-rc.51`, and the expected Kubernetes version constraint.
...
curl --fail --location --silent --show-error \
  ...
  https://raw.githubusercontent.com/szymczag/hangar/hangar-v0.1.0-rc.51/charts/hangar/examples/evaluation-secrets.example.yaml
```
