...
verifying the public `0.1.0-rc.10` release.
...
For `0.1.0-rc.10`, the trust chain is:

1. signed Git tag `hangar-v0.1.0-rc.10` identifies the source commit;
...
```bash
export VERSION=0.1.0-rc.10
export GIT_TAG=hangar-v0.1.0-rc.10
...
`0.1.0-rc.10` is a prerelease. Only the evaluation profile has completed live
