...
verifying the public `0.1.0-rc.23` release.
...
For `0.1.0-rc.23`, the trust chain is:

1. signed Git tag `hangar-v0.1.0-rc.23` identifies the source commit;
...
```bash
export VERSION=0.1.0-rc.23
export GIT_TAG=hangar-v0.1.0-rc.23
...
`0.1.0-rc.23` is a prerelease. Only the evaluation profile has completed live
