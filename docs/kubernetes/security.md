...
verifying the public `0.1.0-rc.7` release.
...
For `0.1.0-rc.7`, the trust chain is:

1. signed Git tag `hangar-v0.1.0-rc.7` identifies the source commit;
...
export GIT_TAG=hangar-v0.1.0-rc.7
...
`0.1.0-rc.7` is a prerelease. Only the evaluation profile has completed live
