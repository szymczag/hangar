...
> [!CAUTION]
> Hangar `0.1.0-rc.16` is not supported for production. The production profile
...
curl --fail --location --silent --show-error \
  ...
  https://raw.githubusercontent.com/szymczag/hangar/hangar-v0.1.0-rc.16/charts/hangar/examples/production-values.yaml
```
