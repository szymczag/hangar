...
The current release is `0.1.0-rc.51`. It is qualified for evaluation on
...
The `0.1.0-rc.51` qualification boundary is:
...
| ------------------ | -------------------------------------------- |
| Product version    | `v0.1.0-rc.51`                               |
| Helm chart version | `0.1.0-rc.51`                                |
| Git tag            | `hangar-v0.1.0-rc.51`                        |
| OCI chart          | `ghcr.io/szymczag/charts/hangar:0.1.0-rc.51` |
...
- [Release `v0.1.0-rc.51` notes](../releases/hangar-v0.1.0-rc.51.md) — review
...
The public `rc.51` chart archive, OCI chart, and digest-pinned Hangar images are
