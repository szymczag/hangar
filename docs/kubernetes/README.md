...
The current release is `0.1.0-rc.40`. It is qualified for evaluation on
...
The `0.1.0-rc.40` qualification boundary is:
...
| ------------------ | -------------------------------------------- |
| Product version    | `v0.1.0-rc.40`                               |
| Helm chart version | `0.1.0-rc.40`                                |
| Git tag            | `hangar-v0.1.0-rc.40`                        |
| OCI chart          | `ghcr.io/szymczag/charts/hangar:0.1.0-rc.40` |
...
installation, upgrade, or rollback targets. `rc.39` is the immediately previous
...
- [Release `v0.1.0-rc.40` notes](../releases/hangar-v0.1.0-rc.40.md) — review
...
The public `rc.40` chart archive, OCI chart, and digest-pinned Hangar images are
