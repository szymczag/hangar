...
The current release is `0.1.0-rc.41`. It is qualified for evaluation on
...
The `0.1.0-rc.41` qualification boundary is:
...
| ------------------ | -------------------------------------------- |
| Product version    | `v0.1.0-rc.41`                               |
| Helm chart version | `0.1.0-rc.41`                                |
| Git tag            | `hangar-v0.1.0-rc.41`                        |
| OCI chart          | `ghcr.io/szymczag/charts/hangar:0.1.0-rc.41` |
...
installation, upgrade, or rollback targets. `rc.40` is the immediately previous
...
- [Release `v0.1.0-rc.41` notes](../releases/hangar-v0.1.0-rc.41.md) — review
...
The public `rc.41` chart archive, OCI chart, and digest-pinned Hangar images are
