...
The current release is `0.1.0-rc.50`. It is qualified for evaluation on
...
The `0.1.0-rc.50` qualification boundary is:
...
| ------------------ | -------------------------------------------- |
| Product version    | `v0.1.0-rc.50`                               |
| Helm chart version | `0.1.0-rc.50`                                |
| Git tag            | `hangar-v0.1.0-rc.50`                        |
| OCI chart          | `ghcr.io/szymczag/charts/hangar:0.1.0-rc.50` |
...
- [Release `v0.1.0-rc.50` notes](../releases/hangar-v0.1.0-rc.50.md) — review
...
The public `rc.50` chart archive, OCI chart, and digest-pinned Hangar images are
