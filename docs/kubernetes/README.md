...
The current release is `0.1.0-rc.46`. It is qualified for evaluation on
...
The `0.1.0-rc.46` qualification boundary is:
...
| ------------------ | -------------------------------------------- |
| Product version    | `v0.1.0-rc.46`                               |
| Helm chart version | `0.1.0-rc.46`                                |
| Git tag            | `hangar-v0.1.0-rc.46`                        |
| OCI chart          | `ghcr.io/szymczag/charts/hangar:0.1.0-rc.46` |
...
installation, upgrade, or rollback targets. `rc.45` is the immediately previous
...
- [Release `v0.1.0-rc.46` notes](../releases/hangar-v0.1.0-rc.46.md) — review
...
The public `rc.46` chart archive, OCI chart, and digest-pinned Hangar images are
