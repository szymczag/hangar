...
The current release is `0.1.0-rc.35`. It is qualified for evaluation on
...
The `0.1.0-rc.35` qualification boundary is:
...
| ------------------ | -------------------------------------------- |
| Product version    | `v0.1.0-rc.35`                               |
| Helm chart version | `0.1.0-rc.35`                                |
| Git tag            | `hangar-v0.1.0-rc.35`                        |
| OCI chart          | `ghcr.io/szymczag/charts/hangar:0.1.0-rc.35` |
...
- [Release `v0.1.0-rc.35` notes](../releases/hangar-v0.1.0-rc.35.md) — review
...
The public `rc.35` chart archive, OCI chart, and digest-pinned Hangar images are
