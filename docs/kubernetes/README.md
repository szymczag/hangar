...
The current release is `0.1.0-rc.48`. It is qualified for evaluation on
...
The `0.1.0-rc.48` qualification boundary is:
...
| ------------------ | -------------------------------------------- |
| Product version    | `v0.1.0-rc.48`                               |
| Helm chart version | `0.1.0-rc.48`                                |
| Git tag            | `hangar-v0.1.0-rc.48`                        |
| OCI chart          | `ghcr.io/szymczag/charts/hangar:0.1.0-rc.48` |
...
- [Release `v0.1.0-rc.48` notes](../releases/hangar-v0.1.0-rc.48.md) — review
...
The public `rc.48` chart archive, OCI chart, and digest-pinned Hangar images are
