...
The current release is `0.1.0-rc.47`. It is qualified for evaluation on
...
The `0.1.0-rc.47` qualification boundary is:
...
| ------------------ | -------------------------------------------- |
| Product version    | `v0.1.0-rc.47`                               |
| Helm chart version | `0.1.0-rc.47`                                |
| Git tag            | `hangar-v0.1.0-rc.47`                        |
| OCI chart          | `ghcr.io/szymczag/charts/hangar:0.1.0-rc.47` |
...
installation, upgrade, or rollback targets. `rc.46` is the immediately previous
...
- [Release `v0.1.0-rc.47` notes](../releases/hangar-v0.1.0-rc.47.md) — review
...
The public `rc.47` chart archive, OCI chart, and digest-pinned Hangar images are
