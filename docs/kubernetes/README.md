...
The current release is `0.1.0-rc.52`. It is qualified for evaluation on
...
The `0.1.0-rc.52` qualification boundary is:
...
| ------------------ | -------------------------------------------- |
| Product version    | `v0.1.0-rc.52`                               |
| Helm chart version | `0.1.0-rc.52`                                |
| Git tag            | `hangar-v0.1.0-rc.52`                        |
| OCI chart          | `ghcr.io/szymczag/charts/hangar:0.1.0-rc.52` |
...
- [Release `v0.1.0-rc.52` notes](../releases/hangar-v0.1.0-rc.52.md) — review
...
The public `rc.52` chart archive, OCI chart, and digest-pinned Hangar images are
