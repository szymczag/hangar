...
The current release is `0.1.0-rc.49`. It is qualified for evaluation on
...
The `0.1.0-rc.49` qualification boundary is:
...
| ------------------ | -------------------------------------------- |
| Product version    | `v0.1.0-rc.49`                               |
| Helm chart version | `0.1.0-rc.49`                                |
| Git tag            | `hangar-v0.1.0-rc.49`                        |
| OCI chart          | `ghcr.io/szymczag/charts/hangar:0.1.0-rc.49` |
...
- [Release `v0.1.0-rc.49` notes](../releases/hangar-v0.1.0-rc.49.md) — review
...
The public `rc.49` chart archive, OCI chart, and digest-pinned Hangar images are
