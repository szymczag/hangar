...
| #   | File                                                                                                                                              | Phase       | Nature                                                                                                                                                          |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | `apps/api/plane/settings/common.py`                                                                                                               | 0, Runner 1 | append `plane.ext` to `INSTALLED_APPS`; add the default-off `RUNNER_ENABLED` instance gate                                                                      |
...
| 24  | `.env.example`, `apps/api/.env.example`, `deployments/*/community/variables.env`                                                                  | 5, Runner 1 | document privacy-preserving defaults for telemetry and discovery plus disabled Runner activation                                                                |
