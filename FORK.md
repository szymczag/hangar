...
| 24  | `.env.example`, `apps/api/.env.example`, `deployments/*/community/variables.env`                                                                  | 5     | document empty privacy-preserving defaults for telemetry, release discovery, and changelog links |
