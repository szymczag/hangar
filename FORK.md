...
| 12  | `apps/api/plane/db/models/issue.py`, issue serializers, and app/public issue and intake write paths                                               | 2, Epic types | include Epics in the normal work-item manager; expose type identity; enforce same-project, acyclic, transactionally serialized hierarchy mutations              |
| 13  | `apps/web/core/store/issue/issue-details/`, work-item relations, commands, navigation, and peek helpers                                           | 2, Epic types | route Epic interactions through the shared work-item store and services; retain only server-side legacy API adapters                                            |
