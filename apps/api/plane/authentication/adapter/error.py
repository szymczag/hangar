...
AUTHENTICATION_ERROR_CODES = {
    ...
    # Every cryptographic failure answers ADMIN_2FA_VERIFICATION_FAILED so the
    # response cannot distinguish an unknown credential from a bad signature.
    "ADMIN_2FA_REQUIRED": 5191,
    "ADMIN_2FA_SESSION_EXPIRED": 5192,
    "ADMIN_2FA_VERIFICATION_FAILED": 5193,
    "ADMIN_2FA_ENROLLMENT_REQUIRED": 5194,
    "ADMIN_2FA_NOT_CONFIGURED": 5195,
    "ADMIN_2FA_ATTEMPTS_EXHAUSTED": 5196,
    "ADMIN_2FA_LAST_CREDENTIAL": 5197,
    # Rate limit
