...
CALENDAR_CAPACITY_USER_RATE = _rate_setting("CALENDAR_CAPACITY_USER_RATE", "20/minute")
CALENDAR_CAPACITY_WORKSPACE_RATE = _rate_setting("CALENDAR_CAPACITY_WORKSPACE_RATE", "60/minute")
