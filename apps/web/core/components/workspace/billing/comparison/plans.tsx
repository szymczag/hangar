...
export type THangarPlans = "free" | "one" | "pro" | "business" | "enterprise";
...
type TPlanFeatureDetails = {
  ...
  cloud: Record<THangarPlans, TPlanFeatureData>;
  "self-hosted"?: Record<THangarPlans, TPlanFeatureData>;
};
...
type HangarPlans = {
  planDetails: Record<THangarPlans, TPlanDetail>;
  planHighlights: Record<THangarPlans, string[]>;
...
export const PLANS_LIST: THangarPlans[] = ["free", "one", "pro", "business", "enterprise"];
...
export const PLANS_COMPARISON_LIST: TPlansComparisonDetails[] = [
    ...
    features: [
      {
        ...
        description:
          "Track progress in cycles, modules, and overviews\nthroughout Hangar without switching to dashboards\nor Analytics.",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      ...
      // },
      {
        title: "PQL",
        description:
          "Write Hangar Query Language in search with support\nfor Boolean operators. Soon, you can write natural\nlanguage queries.",
        cloud: {
          free: false,
          one: false,
          pro: true,
    ...
    features: [
      {
        title: "GitHub",
        description:
          "Sync Hangar work items and states to GitHub work items and\nstates. Update GitHub automatically with activity\nfrom Hangar and vice-versa.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Slack",
        description: "Get Hangar activity in Slack and use / commands in\nSlack to make changes in Hangar.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Zendesk",
        description: "Create Hangar work items from Zendesk tickets.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Freshdesk",
        description: "Create Hangar work items from Freshdesk tickets.",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Choose other domains that can authenticate into\nyour Hangar workspace or restrict all but one domain.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      },
      {
        ...
        description: "Secure your Hangar workspace with device-\ndependent two-factor authentication and passkeys. ",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      {
        title: "God Mode",
        description: "Manage your self-hosted Hangar instance better with\nan instance admin interface.",
        cloud: {
          free: true,
          one: true,
          pro: true,
      ...
      },
      {
        ...
        description: "Install and deploy your self-hosted Hangar to any\nprivate cloud with a single-line command.",
        cloud: {
          free: false,
          one: true,
          pro: true,
        ...
        description: (
          <>
            ...
            <a
              ...
              className="underline"
            >
              can be discussed in a GitHub issue
            </a>
            .
          </>
        ),
...
export const PLANE_PLANS: HangarPlans = {
  planDetails: {
    free: {
