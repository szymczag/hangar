...
const integrationDetails: { [key: string]: any } = {
  github: {
    ...
    notInstalled: "Connect with GitHub with your Hangar workspace to sync project work items.",
  },
  slack: {
    logo: SlackLogo,
    installed: "Activate Slack on individual projects to sync with specific channels.",
    notInstalled: "Connect with Slack with your Hangar workspace to sync project work items.",
  },
};
