...
// plane imports
import { DOCUMENTATION_URL, PROJECT_TRACKER_ELEMENTS } from "@plane/constants";
  ...
  return (
    <div className="mx-auto flex h-full max-w-[480px] flex-col items-center justify-center gap-4">
      ...
      <div className="flex gap-2">
        <Link href={DOCUMENTATION_URL} target="_blank" className={cn(getButtonStyling("secondary", "base"))}>
