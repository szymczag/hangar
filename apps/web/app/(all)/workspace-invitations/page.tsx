        ...
        {invitationDetail && !invitationDetail.responded_at ? (
          error ? (
            ...
            <EmptySpace
              ...
              description="Your workspace is where you'll create projects, collaborate on your work items, and organize different streams of work in your Hangar account."
            >
